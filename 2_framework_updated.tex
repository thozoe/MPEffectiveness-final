...
Moreover, the prior choice of the parameters governing the state transition ensures a sensible state allocation, with both regimes clearly separated. That is, the threshold parameter follows a weakly informative uniform distribution, while we impose a Gamma prior on the speed of adjustment parameter. The hyperparameters for the latter are set so that the transition between the two states is relatively fast. 
